          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="intro-text">
                      ...
                      <hr class="star-light">
                      <span class="skills">Here's information about your favorite movie.</span>
                  </div>
              </div>
          </div>
      </div>
        ...
        <p>Movie ID: ${movie.id}</p>
				<p>Stars:
					<c:forEach items="${movie.stars}" var="star">
						<a href="<%=request.getContextPath()%>/StarsListController?starid=${star.id}">${star.first_name} ${star.last_name}</a>,
					</c:forEach>
				</p>
				<p>Genres:
